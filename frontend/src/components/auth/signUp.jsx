...
export const SignUp = ({}) => {
    ...
    const {
        ...
        defaultValues: {
            email: "test2@test.ru", login: "testUser2", name: "Ivan", surname: "Ivanov", password: "123456",
        }, mode: "onChange",
    });
                ...
                <article className={s.inputs}>
                    ...
                    <section>
                        <input
                            placeholder="Login"
                            {...register("login", {
                                required: "please enter your login", pattern: {
                                    value: /^[a-zA-Z0-9]+$/,
                                    message: "login can only contain  english letters and numbers",
                                }, minLength: {
                                    value: 5, message: "minimum login length is 5",
                                }, maxLength: {
                                    value: 25, message: "maximum login length is 25",
                                },
                            })}
                        />
                        <footer className={s.helpText}>
                        ...
                        <input
                            ...
                            {...register("name", {
                                required: "please enter your name", pattern: {
                                    value: /^[A-Za-z]+$/i, message: "you can use only english letters",
                                }, minLength: {
                                    value: 2, message: "minimum name length is 2",
                                }, maxLength: {
                                    value: 25, message: "maximum name length is 25",
                                },
                            })}
                        />
                        <footer className={s.helpText}>
                    ...
                    <section>
                        <input
                            placeholder="Surname"
                            {...register("surname", {
                                required: "please enter your surname", pattern: {
                                    value: /^[A-Za-z]+$/i, message: "you can use only english  letters",
                                }, minLength: {
                                    value: 2, message: "minimum surname length is 2",
                                }, maxLength: {
                                    value: 25, message: "maximum surname length is 25",
                                },
                            })}
                        />
                        <footer className={s.helpText}>
